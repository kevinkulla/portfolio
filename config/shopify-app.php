...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'kevinkullastore'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '7c915607102c4d5dfce573a215523770'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_customers,write_customers,read_orders,write_orders,read_shipping,write_shipping,read_checkouts,write_checkouts,read_locales,read_script_tags,write_script_tags,read_locations'),
